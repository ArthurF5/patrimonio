...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="<?php echo site_url();?>/patrimonio/minhaConta"><i class="icon icon-star"></i> <span class="text">Minha Conta</span></a></li>
    <li class=""><a title="" href="<?php echo site_url();?>/mine"><i class="icon icon-eye-open"></i> <span class="text">Área do Cliente</span></a></li>
    <li class="pull-right"><a href="https://github.com/RamonSilva20/patrimonio" target="_blank"><i class="icon icon-asterisk"></i> <span class="text">Versão: <?php echo $this->config->item('app_version'); ?></span></a></li>
    <li class=""><a title="" href="<?php echo site_url();?>/patrimonio/sair"><i class="icon icon-share-alt"></i> <span class="text">Sair do Sistema</span></a></li>
...
<!--start-top-serch-->
<div id="search">
  <form action="<?php echo base_url()?>index.php/patrimonio/pesquisar">
...
};?>"><a href="<?php echo base_url()?>index.php/bens"><i class="icon icon-barcode"></i> <span>Bens</span></a></li>
    <?php } ?>
    ...
    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rCliente') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rProduto') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rServico') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rOs') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rVenda')) { ?>
        ...
        <li class="submenu <?php if (isset($menuRelatorios)) {
          ...
          <ul>
                ...
                <li><a href="<?php echo base_url()?>index.php/relatorios/bens">Bens</a></li>
                <li><a href="<?php echo base_url()?>index.php/relatorios/movimentacoes">Movimentações</a></li>
        ...
        <li class="submenu <?php if (isset($menuConfiguracoes)) {
          ...
          <ul>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'cEmitente')) { ?>
                <li><a href="<?php echo base_url()?>index.php/patrimonio/emitente">Emitente</a></li>
            <?php } ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'cBackup')) { ?>
                <li><a href="<?php echo base_url()?>index.php/patrimonio/backup">Backup</a></li>
            <?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <a href="https://github.com/RamonSilva20/patrimonio" target="_blank"><?php echo date('Y'); ?> &copy; Patrimônio - PC </a></div>
</div>
<!--end-Footer-part-->

...
class Patrimonio extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['ordens'] = $this->patrimonio_model->getOsAbertas();
        $this->data['produtos'] = $this->patrimonio_model->getProdutosMinimo();
        $this->data['os'] = $this->patrimonio_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->patrimonio_model->getEstatisticasFinanceiro();
        $this->data['menuPainel'] = 'Painel';
        $this->data['view'] = 'patrimonio/painel';
    ...
    public function minhaConta()
    {
        ...
        $this->data['usuario'] = $this->patrimonio_model->getById($this->session->userdata('id'));
        $this->data['view'] = 'patrimonio/minhaConta';
        $this->load->view('tema/topo', $this->data);
    ...
    public function alterarSenha()
    {
        ...
        $result = $this->patrimonio_model->alterarSenha($senha, $oldSenha, $this->session->userdata('id'));
        if ($result) {
            $this->session->set_flashdata('success', 'Senha Alterada com sucesso!');
            redirect(base_url() . 'index.php/patrimonio/minhaConta');
        } else {
    ...
    public function pesquisar()
    {
        ...
        $data['results'] = $this->patrimonio_model->pesquisar($termo);
        $this->data['produtos'] = $data['results']['produtos'];
        $this->data['servicos'] = $data['results']['servicos'];
        $this->data['os'] = $data['results']['os'];
        $this->data['clientes'] = $data['results']['clientes'];
        $this->data['view'] = 'patrimonio/pesquisa';
        $this->load->view('tema/topo', $this->data);
    ...
    public function login()
    {
        ...
        $this->load->view('patrimonio/login');
    ...
    public function verificarLogin()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $user = $this->patrimonio_model->check_credentials($email);
    ...
    public function emitente()
    {
        ...
        $data['dados'] = $this->patrimonio_model->getEmitente();
        $data['view'] = 'patrimonio/emitente';
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url().'index.php/patrimonio/emitente');
            ...
            $retorno = $this->patrimonio_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email, $logo);
            if ($retorno) {
    ...
    public function editarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->patrimonio_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email);
            if ($retorno) {
    ...
    public function editarLogo()
    {
        ...
        $retorno = $this->patrimonio_model->editLogo($id, $logo);
        if ($retorno) {

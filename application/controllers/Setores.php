...
class Setores extends CI_Controller
{
    ...
    function gerenciar()
    {
        ...
        $config['base_url'] = base_url().'index.php/setores/gerenciar/';
        $config['total_rows'] = $this->setores_model->count('setores');
        $config['per_page'] = 10;
        ...
        $this->data['results'] = $this->setores_model->get('setores', 'id,descricao,instituicao_id', '', $config['per_page'], $this->uri->segment(3));

        $this->data['view'] = 'setores/setores';

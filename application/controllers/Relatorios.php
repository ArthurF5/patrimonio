...
class Relatorios extends CI_Controller
{
    ...
    {
        $this->data['view'] = 'relatorios/rel_bens';
        $this->load->view('tema/topo', $this->data);

    }
    public function movimentacoes()
    {
        $this->data['view'] = 'relatorios/rel_movimentacoes';
        $this->load->view('tema/topo', $this->data);
    ...
    public function bensRapid()
    {
        ...
        $data['bens'] = $this->Relatorios_model->bensRapid();

        $this->load->helper('mpdf');
        $this->load->helper('codegen');
        $html = $this->load->view('relatorios/imprimir/imprimirBens', $data, true);
        pdf_create($html, 'relatorio_bens' . date('d/m/y'), true);
    ...
    public function movimentacoesRapid()
    {
        ...
        $data['movimentacoes'] = $this->Relatorios_model->movimentacoesRapid();

        $this->load->helper('mpdf');
        $this->load->helper('codegen');
        $html = $this->load->view('relatorios/imprimir/imprimirMovimentacoes', $data, true);
        pdf_create($html, 'relatorio_movimentacoes' . date('d/m/y'), true);
    ...
    public function osCustom()
    {
        ...
        $emitente = $this->patrimonio_model->getEmitente();
